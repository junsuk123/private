...
setdefault REALTIME_COLLECTOR_MAX_SYMBOLS "40"
setdefault REALTIME_BUY_CANDIDATE_LIMIT "360"
setdefault REALTIME_BUY_CANDIDATE_MAX_AGE_SEC "180"
setdefault REALTIME_MAX_BUY_EVALUATIONS_PER_CYCLE "40"
