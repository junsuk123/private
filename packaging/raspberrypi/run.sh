...
setdefault REALTIME_SMALL_ACCOUNT_MAX_POSITION_WEIGHT "1.25"
setdefault REALTIME_ONE_SHARE_CASH_BUFFER "1.03"
setdefault REALTIME_MAX_BUY_ORDERS_PER_CYCLE "2"
setdefault REALTIME_MIN_NET_PROFIT_BUFFER_RATE "0.0"
setdefault REALTIME_COLLECTOR_MAX_SYMBOLS "30"
setdefault REALTIME_BUY_CANDIDATE_LIMIT "160"
setdefault REALTIME_BUY_CANDIDATE_MAX_AGE_SEC "240"
setdefault REALTIME_MAX_BUY_EVALUATIONS_PER_CYCLE "24"
setdefault REALTIME_AFFORDABLE_CANDIDATE_TTL_SEC "90"
setdefault REALTIME_US_DISCOVERY_CANDIDATE_LIMIT "4"
setdefault REALTIME_KRX_DISCOVERY_CANDIDATE_LIMIT "4"
setdefault REALTIME_US_FEATURE_WARM_LIMIT "4"
setdefault REALTIME_US_REST_WARM_PASSES "1"
setdefault REALTIME_US_FAST_POLL_SEC "20"
setdefault REALTIME_MIN_BUY_NET_RETURN_US "0.0005"
setdefault REALTIME_FALLBACK_EDGE_BPS_PER_SCORE "220"
setdefault REALTIME_US_EXCLUDE_SYMBOL_SUFFIXES "U,WS,WT,W,R,P"
setdefault REALTIME_ALLOW_LOSS_EXIT "false"
setdefault REALTIME_HARD_STOP_LOSS "0.03"
setdefault REALTIME_EMERGENCY_STOP_LOSS "0.05"
setdefault REALTIME_STOP_LOSS_NET "0.0"
